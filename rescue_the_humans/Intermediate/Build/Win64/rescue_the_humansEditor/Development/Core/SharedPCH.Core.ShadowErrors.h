// PCH for C:\Program Files (x86)\Epic Games\UE_4.26\Engine\Source\Runtime\Core\Public\CoreSharedPCH.h
#define IS_PROGRAM 0
#define UE_EDITOR 1
...
#include "C:/Program Files (x86)/Epic Games/UE_4.26/Engine/Source/Runtime/Core/Public/CoreSharedPCH.h"
